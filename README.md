...
## Задание 2. 
###  Построить графики зависимости колчества эпох от ошибки обучения. Указать от чего зависит необходимое количество эпох обучения.
...
## Выводы
В процессе выполнения 4 лабораторной работы я познакомился с программными средствами для создания системы машинного обучения и её интеграции в Unity, изучил характерные свойства и особенности перцептрона. Применил перцептрон для реализации стандартных логических операторов и выяснил, что корректность исполненения будет присутствовать для функций линейного типа `aX+b`
